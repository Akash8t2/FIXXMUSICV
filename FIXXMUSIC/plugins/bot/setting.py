...
from FIXXMUSIC.utils.decorators.admins import ActualAdminCB
from FIXXMUSIC.utils.decorators.language import language, languageCB
from FIXXMUSIC.utils.inline.settings import (
    auth_users_markup,
...
@app.on_message(
    filters.command(["settings", "setting" , "vashusg"]) & filters.group & ~BANNED_USERS
)
@language
